/*
Copyright (C): 2021-2022, Zhuhai Ruoqing Tech
modified from L
load dependency
"Ruoqing": "file:../pxt-Ruoqing"
*/

//% color=#AEDD81 weight=180 icon="\uf06c"
namespace Ruoqing {
     ...
     * @param index
     */   
    //% blockId=Ruoqing_RGB_Program block="RGB_Program"
    //% weight=99
    //% blockGap=10
    ...
    //% blockId=Ruoqing_Music block="Music|%index"
    //% weight=98
    //% blockGap=10
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=Ruoqing_Servo block="Servo(180°)|num %num|value %value"
    //% weight=97
    //% blockGap=10
    ...
    //% blockId=Ruoqing_Servo2 block="Servo(270°)|num %num|value %value"
    //% weight=96
    //% blockGap=10
    ...
    //% blockId=Ruoqing_Servo3 block="Servo(360°)|num %num|pos %pos|value %value"
    //% weight=96
    //% blockGap=10
    ...
    //% blockId=Ruoqing_MotorRun block="Motor|%index|speed(-255~255) %speed"
    //% weight=93
    ...
    //% blockId=Ruoqing_MotorRunDual block="Motor|%motor1|speed %speed1|%motor2|speed %speed2"
    //% weight=92
    //% blockGap=50
    ...
    //% blockId=Ruoqing_StepperDegree block="Stepper Motor(28BYJ-48) |%index|degree %degree"
    //% weight=90
    ...
    //% blockId=Ruoqing_MotorStopAll block="Motor Stop All"
    //% weight=91
    //% blockGap=50
    ...
    //% blockId=Ruoqing_StepperTurn block="Stepper Motor(28BYJ-48) |%index|turn %turn|circle"
    //% weight=89
    ...
    //% blockId=Ruoqing_StepperDual block="Dual Stepper Motor(Degree) |M1 %degree1| M2 %degree2"
    //% weight=88
    ...
    //% blockId=Ruoqing_PWMOFF block="PWM OFF|%index"
    //% weight=87
